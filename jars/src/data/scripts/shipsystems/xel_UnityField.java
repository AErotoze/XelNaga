...
public class xel_UnityField extends xel_BaseShipSystemScript {
	/*
	 * 统合力场
	...
	public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
		...
		String spriteName = Global.getSettings().getShipSystemSpec(ShipSystemUtil.XEL_UNITY_FIELD).getIconSpriteName();
		String title = hasPP(ship) ? i18n_hullmod.get("xel_pp_UF_change_name") : xel_Misc.getShipSystemSpecName(ShipSystemUtil.XEL_UNITY_FIELD);
		...
		if (isPlayerShip(ship)) {
			engine.maintainStatusForPlayerShip(STATUS1, spriteName, title, i18n_shipSystem.get("xel_UF_active"), false);
		}
	}
