                ...
                targetData.targetEffectListener = new AdvanceableListener() {
                    ...
                    public void advance(float amount) {
                        ...
                        if (activeTime > 0f) {
                            ...
                            if (hasPP(source))
                                target.setJitter(TARGET_KEY, PP_STASIS_COLOR, level, 3, ship.getCollisionRadius() * 0.5f * level);
                            else
                                target.setJitter(TARGET_KEY, STASIS_COLOR, level, 3, ship.getCollisionRadius() * 0.5f * level);
